...
//        output.metadataObjectTypes=a;
        ...
        [output setMetadataObjectTypes:
         @[AVMetadataObjectTypeQRCode,         //二维码
           ...
           AVMetadataObjectTypeCode128Code,    //商品条码  顺丰用的
...
-(void)captureOutput:(AVCaptureOutput *)captureOutput didOutputMetadataObjects:(NSArray *)metadataObjects fromConnection:(AVCaptureConnection *)connection{
    if (metadataObjects.count>0) {
        ...
        NSLog(@"%@",data);
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:nil message:data delegate:nil cancelButtonTitle:@"取消" otherButtonTitles:nil, nil];
        [alert show];
